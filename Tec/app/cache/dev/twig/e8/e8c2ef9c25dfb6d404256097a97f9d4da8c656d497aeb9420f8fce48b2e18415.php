...
class __TwigTemplate_0ea184e34358b92dc7af525c78cbcbe553b9dc44e6539617d29ecfe1d6401556 extends Twig_Template
{
...
(isset($context["parent"]) ? $context["parent"] : $this->getContext($context, "parent")))) {
    ...
    public function block_fos_comment_form_fields($context, array $blocks = array())
    {
        ...
        echo "
                    ";
        // line 37
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "body", array()), 'errors', array("attr" => array("class" => "form-control")));
        echo "
                    </div>
                    ";
        // line 39
    ...
    public function block_fos_comment_form_submit($context, array $blocks = array())
    {
        ...
        // line 49
        echo "                        <input type=\"submit\" class=\"btn btn-lg btn-ghost btn-blue\"  value=\"";
...
/*                     {{ form_errors(form) }}*/
/*                     {{ form_errors(form.body,{'attr':{'class':'form-control'}}) }}*/
/*                     </div>*/
...
/*                         {% endif %}*/
/*                         <input type="submit" class="btn btn-lg btn-ghost btn-blue"  value="{% trans from 'FOSCommentBundle' %}fos_comment_comment_new_submit{% endtrans %}" />*/
/*                     {% endblock %}*/
/*                 </div>*/
/* */
/*             </form>*/

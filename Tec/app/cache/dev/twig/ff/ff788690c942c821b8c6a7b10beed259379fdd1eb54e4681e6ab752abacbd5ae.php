...
class __TwigTemplate_fcfc18ba6b15b4689cec77e5e99ccf2c41715fcadb5b281a554c81734539bdf0 extends Twig_Template
{
...
";
    ...
    {
        // line 28
        echo "                <input type=\"submit\" class=\"btn btn-lg btn-ghost btn-black\" value=\"";
...
/*                 <input type="submit" class="btn btn-lg btn-ghost btn-black" value="{{ (isCommentable ? 'fos_comment_thread_open' : 'fos_comment_thread_close') | trans({}, 'FOSCommentBundle') }}" />*/
/*             {% endblock %}*/
/*         </div>*/
/* */
/*     </form>*/

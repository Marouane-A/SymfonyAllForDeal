...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Application\\EcommerceBundle\\Controller\\DefaultController::indexAction',  '_route' => 'ecommerce_homepage',);
        }

        if (0 === strpos($pathinfo, '/panier')) {
            if (0 === strpos($pathinfo, '/panierA')) {
                // ecommerce_panierAjout
                if (0 === strpos($pathinfo, '/panierAjout') && preg_match('#^/panierAjout/(?P<id>[^/]++)/(?P<nom>[^/]++)/(?P<prix>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'ecommerce_panierAjout')), array (  '_controller' => 'Application\\EcommerceBundle\\Controller\\PanierController::ajouterAction',));
                }

                // ecommerce_panierAffichage
                if ($pathinfo === '/panierAffichage') {
                    return array (  '_controller' => 'Application\\EcommerceBundle\\Controller\\PanierController::panierAction',  '_route' => 'ecommerce_panierAffichage',);
                }

            }

            // ecommerce_panierSupprimer
            if (0 === strpos($pathinfo, '/panierSupprimer') && preg_match('#^/panierSupprimer/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ecommerce_panierSupprimer')), array (  '_controller' => 'Application\\EcommerceBundle\\Controller\\PanierController::supprimerAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/api/threads')) {
            ...
            if (0 === strpos($pathinfo, '/api/threads/new') && preg_match('#^/api/threads/new(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/commentable/edit(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/comments/new(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/comments/(?P<commentId>[^/]++)/remove(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/comments/(?P<commentId>[^/]++)/edit(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/comments/(?P<commentId>[^/]++)/votes/new(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/\\.]++)(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/commentable(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/comments/(?P<commentId>[^/\\.]++)(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/comments/(?P<commentId>[^/]++)/state(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'PATCH') {
                    $allow[] = 'PATCH';
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/comments(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (preg_match('#^/api/threads/(?P<id>[^/]++)/comments/(?P<commentId>[^/]++)/votes(?:\\.(?P<_format>rss|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
        ...
        if (0 === strpos($pathinfo, '/mail')) {
            // application_mail_homepage
            if (0 === strpos($pathinfo, '/mail/hello') && preg_match('#^/mail/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'application_mail_homepage')), array (  '_controller' => 'Application\\MailBundle\\Controller\\DefaultController::indexAction',));
            }

            // application_mail_redirection
            if ($pathinfo === '/mail/redirection') {
                return array (  '_controller' => 'Application\\MailBundle\\Controller\\DefaultController::redirectionAction',  '_route' => 'application_mail_redirection',);
            }

            // application_mail_sendMail
            if ($pathinfo === '/mail/sendMail') {
                return array (  '_controller' => 'Application\\MailBundle\\Controller\\DefaultController::sendMailAction',  '_route' => 'application_mail_sendMail',);
            }
        ...
        if (0 === strpos($pathinfo, '/produit')) {
            ...
            // produit_afficherPS
            if (0 === strpos($pathinfo, '/produit/afficherPS') && preg_match('#^/produit/afficherPS/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'produit_afficherPS')), array (  '_controller' => 'Application\\ProduitBundle\\Controller\\ProduitController::afficherPSAction',));
            }

            // produit_rechercheP
            if ($pathinfo === '/produit/rechercheP') {
                return array (  '_controller' => 'Application\\ProduitBundle\\Controller\\ProduitController::recherchePAction',  '_route' => 'produit_rechercheP',);
            }

            // produit_listerP
            if ($pathinfo === '/produit/listerP') {
                return array (  '_controller' => 'Application\\ProduitBundle\\Controller\\ProduitController::listerPAction',  '_route' => 'produit_listerP',);
            }

            if (0 === strpos($pathinfo, '/produit/A')) {
                // _ajouter_carte_fid
                if ($pathinfo === '/produit/AjouterCarteFid') {
                    return array (  '_controller' => 'Application\\ProduitBundle\\Controller\\CarteFidController::AjouterCarteFidAction',  '_route' => '_ajouter_carte_fid',);
                }

                // _attribuer_point
                if ($pathinfo === '/produit/AttribuerPoint') {
                    return array (  '_controller' => 'Application\\ProduitBundle\\Controller\\CarteFidController::AttribuerPointAction',  '_route' => '_attribuer_point',);
                }

            }

            // _consulter_nb_point
            if ($pathinfo === '/produit/ConsulterNbPoint') {
                return array (  '_controller' => 'Application\\ProduitBundle\\Controller\\CarteFidController::ConsulterNbPointAction',  '_route' => '_consulter_nb_point',);
            }

            // modify
            if (0 === strpos($pathinfo, '/produit/modify') && preg_match('#^/produit/modify(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'modify')), array (  '_controller' => 'Application\\ProduitBundle\\Controller\\CarteFidController::modifyAction',));
            }

            // afficheCarte
            if ($pathinfo === '/produit/afficheCarte') {
                return array (  '_controller' => 'Application\\ProduitBundle\\Controller\\CarteFidController::afficheCarteAction',  '_route' => 'afficheCarte',);
            }

            // delete
            if (0 === strpos($pathinfo, '/produit/delete') && preg_match('#^/produit/delete(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'delete')), array (  '_controller' => 'Application\\ProduitBundle\\Controller\\CarteFidController::deleteAction',));
            }

            if (0 === strpos($pathinfo, '/produit/afficheP')) {
                // produit_affichePForAllUsers
                if ($pathinfo === '/produit/affichePForAllUsers') {
                    return array (  '_controller' => 'Application\\ProduitBundle\\Controller\\ProduitController::affichePForAllUsersAction',  '_route' => 'produit_affichePForAllUsers',);
                }

                // produit_affichePSForAllUsers
                if (0 === strpos($pathinfo, '/produit/affichePSForAllUsers') && preg_match('#^/produit/affichePSForAllUsers/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'produit_affichePSForAllUsers')), array (  '_controller' => 'Application\\ProduitBundle\\Controller\\ProduitController::afficherPSForAllUsersAction',));
                }

            }

            if (0 === strpos($pathinfo, '/produit/recherchePBy')) {
                // produit_recherchePByType
                if (0 === strpos($pathinfo, '/produit/recherchePByType') && preg_match('#^/produit/recherchePByType/(?P<categorie>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'produit_recherchePByType')), array (  '_controller' => 'Application\\ProduitBundle\\Controller\\ProduitController::recherchePByTypeAction',));
                }

                // produit_recherchePByZone
                if (0 === strpos($pathinfo, '/produit/recherchePByZone') && preg_match('#^/produit/recherchePByZone/(?P<zone>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'produit_recherchePByZone')), array (  '_controller' => 'Application\\ProduitBundle\\Controller\\ProduitController::recherchePByZoneAction',));
                }
        ...
        if (0 === strpos($pathinfo, '/service')) {
            ...
            if (0 === strpos($pathinfo, '/service/offre')) {
                // service_offre
                ...
                // service_offreValide
                if ($pathinfo === '/service/offreValide') {
                    return array (  '_controller' => 'Application\\ServiceBundle\\Controller\\ServiceController::offreValideAction',  '_route' => 'service_offreValide',);
                }
            ...
            // service_afficher
            if (0 === strpos($pathinfo, '/service/afficher') && preg_match('#^/service/afficher/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'service_afficher')), array (  '_controller' => 'Application\\ServiceBundle\\Controller\\ServiceController::afficherAction',));
            }

            // service_listerServices
            if (0 === strpos($pathinfo, '/service/listerServices') && preg_match('#^/service/listerServices/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'service_listerServices')), array (  '_controller' => 'Application\\ServiceBundle\\Controller\\ServiceController::listerServicesAction',));
            }

            if (0 === strpos($pathinfo, '/service/recherche')) {
                // service_recherche
                if ($pathinfo === '/service/recherche') {
                    return array (  '_controller' => 'Application\\ServiceBundle\\Controller\\ServiceController::rechercheAction',  '_route' => 'service_recherche',);
                }

                // service_rechercheType
                if (0 === strpos($pathinfo, '/service/rechercheType') && preg_match('#^/service/rechercheType/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'service_rechercheType')), array (  '_controller' => 'Application\\ServiceBundle\\Controller\\ServiceController::rechercheTypeAction',));
                }

            }

            // service_mesService
            if ($pathinfo === '/service/mesService') {
                return array (  '_controller' => 'Application\\ServiceBundle\\Controller\\ServiceController::mesServicesAction',  '_route' => 'service_mesService',);
            }

            // service_rechercheZone
            if (0 === strpos($pathinfo, '/service/rechercheZone') && preg_match('#^/service/rechercheZone/(?P<zone>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'service_rechercheZone')), array (  '_controller' => 'Application\\ServiceBundle\\Controller\\ServiceController::rechercheZoneAction',));
            }

            // service_gestion
            if ($pathinfo === '/service/gestion') {
                return array (  '_controller' => 'Application\\ServiceBundle\\Controller\\ServiceController::gestionAction',  '_route' => 'service_gestion',);
            }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/application')) {
                if (0 === strpos($pathinfo, '/admin/application/produit/produit')) {
                    // admin_application_produit_produit_list
                    if ($pathinfo === '/admin/application/produit/produit/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'admin.produit',  '_sonata_name' => 'admin_application_produit_produit_list',  '_route' => 'admin_application_produit_produit_list',);
                    }

                    // admin_application_produit_produit_create
                    if ($pathinfo === '/admin/application/produit/produit/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'admin.produit',  '_sonata_name' => 'admin_application_produit_produit_create',  '_route' => 'admin_application_produit_produit_create',);
                    }

                    // admin_application_produit_produit_batch
                    if ($pathinfo === '/admin/application/produit/produit/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'admin.produit',  '_sonata_name' => 'admin_application_produit_produit_batch',  '_route' => 'admin_application_produit_produit_batch',);
                    }

                    // admin_application_produit_produit_edit
                    if (preg_match('#^/admin/application/produit/produit/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_application_produit_produit_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.produit',  '_sonata_name' => 'admin_application_produit_produit_edit',));
                    }

                    // admin_application_produit_produit_delete
                    if (preg_match('#^/admin/application/produit/produit/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_application_produit_produit_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.produit',  '_sonata_name' => 'admin_application_produit_produit_delete',));
                    }

                    // admin_application_produit_produit_show
                    if (preg_match('#^/admin/application/produit/produit/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_application_produit_produit_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.produit',  '_sonata_name' => 'admin_application_produit_produit_show',));
                    }

                    // admin_application_produit_produit_export
                    if ($pathinfo === '/admin/application/produit/produit/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'admin.produit',  '_sonata_name' => 'admin_application_produit_produit_export',  '_route' => 'admin_application_produit_produit_export',);
                    }

                }

                if (0 === strpos($pathinfo, '/admin/application/service/service')) {
                    // admin_application_service_service_list
                    if ($pathinfo === '/admin/application/service/service/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'admin.service',  '_sonata_name' => 'admin_application_service_service_list',  '_route' => 'admin_application_service_service_list',);
                    }

                    // admin_application_service_service_create
                    if ($pathinfo === '/admin/application/service/service/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'admin.service',  '_sonata_name' => 'admin_application_service_service_create',  '_route' => 'admin_application_service_service_create',);
                    }

                    // admin_application_service_service_batch
                    if ($pathinfo === '/admin/application/service/service/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'admin.service',  '_sonata_name' => 'admin_application_service_service_batch',  '_route' => 'admin_application_service_service_batch',);
                    }

                    // admin_application_service_service_edit
                    if (preg_match('#^/admin/application/service/service/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_application_service_service_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.service',  '_sonata_name' => 'admin_application_service_service_edit',));
                    }

                    // admin_application_service_service_delete
                    if (preg_match('#^/admin/application/service/service/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_application_service_service_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.service',  '_sonata_name' => 'admin_application_service_service_delete',));
                    }

                    // admin_application_service_service_show
                    if (preg_match('#^/admin/application/service/service/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_application_service_service_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.service',  '_sonata_name' => 'admin_application_service_service_show',));
                    }

                    // admin_application_service_service_export
                    if ($pathinfo === '/admin/application/service/service/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'admin.service',  '_sonata_name' => 'admin_application_service_service_export',  '_route' => 'admin_application_service_service_export',);
                    }
